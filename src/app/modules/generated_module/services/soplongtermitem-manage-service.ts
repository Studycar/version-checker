...
@Injectable()
export class SopLongTermItemManageService {
    constructor(
      private appApiService: AppApiService,
      private commonQueryService: CommonQueryService,
      private http: _HttpClient,
    ) { }
    seachUrl = '/api/sop/sopLongTermItem/queryPage';
    saveUrl = '';
    ...
    Edit(dto: {[key: string]: any}): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            '/api/sop/sopLongTermItem/saveData',
            {
                ...dto
            });
    }
    ...
    Get(id: string): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            `/api/sop/sopLongTermItem/queryById/${id}`,
            {
            }, { method: 'GET' });
      }
    ...
    RemoveBath(ids: string[]): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            '/api/sop/sopLongTermItem/deleteList', ids
            );
    }

    importData(dtos: any[]): Observable<ResponseDto> {
      return this.http.post<ResponseDto>(
        '/api/sop/sopLongTermItem/fileImport',
        dtos
      );
    }
}
