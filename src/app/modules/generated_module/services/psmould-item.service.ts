...
@Injectable()
export class PsMouldItemManageService {
    constructor(
      private appApiService: AppApiService,
      private commonQueryService: CommonQueryService,
      private http: _HttpClient,
    ) { }
    seachUrl = '/api/sop/sopPsMouldItem/queryPage';
    saveUrl = '';
    ...
    Edit(dto: {[key: string]: any}): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            '/api/sop/sopPsMouldItem/saveData',
            {
                ...dto
            });
    }
    ...
    Get(id: string): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            `/api/sop/sopPsMouldItem/queryById/${id}`,
            {
            }, { method: 'GET' });
      }
    ...
    removeBatch(ids: string[]): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            '/api/sop/sopPsMouldItem/deleteList', ids
            );
    }

    importData(dtos: any[]): Observable<ResponseDto> {
      return this.http.post<ResponseDto>(
        '/api/sop/sopPsMouldItem/fileImport',
        dtos
      );
    }
}
