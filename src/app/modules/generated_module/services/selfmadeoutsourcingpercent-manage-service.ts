...
@Injectable()
export class SelfmadeOutsourcingPercentManageService {
    constructor(
      private appApiService: AppApiService,
      private commonQueryService: CommonQueryService,
      private http: _HttpClient,
    ) { }
    seachUrl = '/api/ps/psSelfmadeOutsourcingPercent/queryPage';
    saveUrl = '';
    ...
    Edit(dto: {[key: string]: any}): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            '/api/ps/psSelfmadeOutsourcingPercent/saveData',
            {
                ...dto
            });
    }
    ...
    Get(id: string): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            `/api/ps/psSelfmadeOutsourcingPercent/queryById/${id}`,
            {
            }, { method: 'GET' });
      }
    ...
    RemoveBath(ids: string[]): Observable<ResponseDto> {
        return this.appApiService.call<ResponseDto>(
            '/api/ps/psSelfmadeOutsourcingPercent/deleteList', ids
            );
    }
