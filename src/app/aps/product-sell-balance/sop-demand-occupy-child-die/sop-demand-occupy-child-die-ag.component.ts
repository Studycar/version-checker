...
@Component({
  ...
  selector: 'product-sell-balance-sop-demand-occupy-child-die-ag',
  templateUrl: './sop-demand-occupy-child-die-ag.component.html',
  providers: [SopDemandOccupyService],
})
export class ProductSellBalanceSopdemandOccupyChildDieAgComponent extends CustomBaseContext implements OnInit {
  ...
  onGridReady(params) {
    ...
    this.setGridWidth('sopdemandoccupychilddie');
  }
  ...
  httpAction = { url: this.editService.seachUrlDieChild, method: 'POST' };
  ...
  public export() {
    super.export();
    this.commonQueryService.export({ url: this.editService.seachUrlDieChildExp, method: 'POST' }, this.getQueryParamsValue(), this.excelexport, this.context);
