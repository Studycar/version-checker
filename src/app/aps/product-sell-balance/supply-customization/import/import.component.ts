...
import { SupplyCustomizationBasic } from '../supply-customization-basic';
...
export class SupplyCustomizationImportComponent extends SupplyCustomizationBasic implements OnInit {
  q: any = {}; // 查询参数
  impColumns = {
