...
@Component({
  ...
  selector: 'product-sell-balance-sop-demand-occupy-child-final-ag',
  templateUrl: './sop-demand-occupy-child-final-ag.component.html',
  providers: [SopDemandOccupyService],
})
export class ProductSellBalanceSopdemandOccupyChildfinalAgComponent extends CustomBaseContext implements OnInit {
  ...
  public columns = [
    { field: 'SALES_TYPE', headerName: '来源', tooltipField: 'SALES_TYPE', menuTabs: ['filterMenuTab'] },
    {
    ...
    {
      field: 'RESOURCE_CODE', headerName: '生产线', tooltipField: 'RESOURCE_CODE', menuTabs: ['filterMenuTab']
    },
    {
      field: 'RESOURCE_DESCRIPTIONS', headerName: '生产线描述', tooltipField: 'RESOURCE_DESCRIPTIONS', menuTabs: ['filterMenuTab']
    },
    {
    ...
    {
      field: 'CAPACITY_DAY', headerName: '日均产能', tooltipField: 'CAPACITY_DAY', menuTabs: ['filterMenuTab']
    },
    {
    ...
    {
      field: 'POPULATION', headerName: '人员需求', tooltipField: 'POPULATION', menuTabs: ['filterMenuTab']
    }
  ];
  ...
  onGridReady(params) {
    ...
    this.setGridWidth('mtsplanoptionchildfinal');
  }

  private getQueryParamsValue(): any {
    return {
      PLANT_CODE: this.p.PLANT_CODE,
      RESOURCE_CODE: this.p.RESOURCE_CODE,
  ...
  httpAction = { url: this.editService.seachUrlFinalChild, method: 'POST' };
  ...
  public export() {
    super.export();
    this.commonQueryService.export({ url: this.editService.seachUrlFinalChildExp, method: 'POST' }, this.getQueryParamsValue(), this.excelexport, this.context);
