...
@Component({
  ...
  selector: 'product-sell-balance-sop-demand-occupy-child-ag',
  templateUrl: './sop-demand-occupy-child-ag.component.html',
  providers: [SopDemandOccupyService],
})
export class ProductSellBalanceSopdemandOccupyChildAgComponent extends CustomBaseContext implements OnInit {
  ...
  onGridReady(params) {
    ...
    this.setGridWidth('sopdemandoccupychild');
  }
  ...
  httpAction = { url: this.editService.seachUrlChild, method: 'POST' };
  public query() {
    super.query();
    this.queryCommon();
  }
  ...
  public export() {
    super.export();
    this.commonQueryService.export({ url: this.editService.seachUrlChildExp, method: 'POST' }, this.getQueryParamsValue(), this.excelexport, this.context);
