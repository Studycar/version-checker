...
import { SelfmadeoutsourcingpercentEditComponent } from './edit/edit.component';
import { AppTranslationService } from 'app/modules/base_module/services/app-translation-service';
import { SelfmadeOutsourcingPercentManageService } from 'app/modules/generated_module/services/selfmadeoutsourcingpercent-manage-service';
...
@Component({
  selector: 'selfmadeoutsourcingpercent-manage',
  templateUrl: './selfmadeoutsourcingpercent.component.html',
  providers: [QueryService, PsItemRoutingsService],
})
export class SelfmadeoutsourcingpercentmManageComponent extends CustomBaseContext implements OnInit {
  ...
  public columns = [
    ...
    { field: 'selfmadePercent', headerName: '自制比例(%)',  menuTabs: ['filterMenuTab'] },    
    { field: 'outsourcingPercent', headerName: '外发比例(%)', menuTabs: ['filterMenuTab'] },    
  ];
  ...
  public clear() {
    this.queryParams.values = {
      ...
      strItemCodeFrom: { value: '', text: '' },
      selfmadePercent: null,
      outsourcingPercent: null,
    }; 
  }

  httpAction = {
    url: this.selfmadeOutsourcingPercentManageService.seachUrl,
    method: 'GET',
    data: false
  };
  ...
  getQueryParams(): { [key: string]: any } {
    return {
      ...
      selfmadePercent: this.queryParams.values.selfmadePercent,
      outsourcingPercent: this.queryParams.values.outsourcingPercent,
  ...
  constructor(
    ...
    private selfmadeOutsourcingPercentManageService: SelfmadeOutsourcingPercentManageService,
  ...
  removeBath() {
    ...
    this.modalService.confirm({
      ...
      nzOnOk: () => {
        this.selfmadeOutsourcingPercentManageService.RemoveBath(this.selectionKeys).subscribe(res => {
          if (res.code === 200) {
  ...
  remove(value: any) {
    this.selfmadeOutsourcingPercentManageService.RemoveBath([value.id]).subscribe(res => {
      if (res.code === 200) {
        this.msgSrv.success(this.translateservice.translate('删除成功'));
        this.query();
      } else {
