...
@Injectable()
export class BankListQueryService extends PlanscheduleHWCommonService {
  constructor(
  ...
  private baseUrl = '/api/ps/pscustomerbank';
  ...
  private setDefaultUrl = this.baseUrl + '/setAsDefault';
  ...
  setAsDefault(id: string): Observable<ResponseDto> {
    return this.http.get(this.setDefaultUrl, {
      id
    });
  }
