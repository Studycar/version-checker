...
@Component({
  ...
  templateUrl: './detail-info-change.component.html',
  providers: [PlanscheduleHWCustomerService]
})
export class PlanscheduleHWCustomerDetailInfoChangeComponent implements OnInit {
  ...
  setHead(data) {
    ...
    this.i.bank = data.bank;
    this.i.bankNum = data.bankNum;
  ...
  async submit(value) {
    ...
    this.ideSubmitService.navigate('ideCustomerDetailInfoChange', {
      formData: Object.assign({}, this.i, {
        annex: JSON.stringify(this.i.annex)        
      })
    })
  }
