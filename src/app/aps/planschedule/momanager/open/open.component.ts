...
export class PlanscheduleMomanagerOpenComponent extends CustomBaseContext implements OnInit {
  expandForm = false;
  ...
  public columns = [
    ...
    {
      field: 'descriptionsCn', headerName: '物料描述', tooltipField: 'descriptionsCn'
    },
    ...
    { field: 'makeOrderType', headerName: '工单类型', tooltipField: 'makeOrderType' },
    {
      field: 'makeOrderStatus', headerName: '工单状态', valueFormatter: 'ctx.optionsFind(value,2).label'
    },
    {
      field: 'projectNumber', headerName: '项目号', tooltipField: 'projectNumber'
    },
    {
      field: 'moQty', headerName: '工单数量'
    },
    {
      field: 'completeNum', headerName: '完工数量'
    },
    {
      field: 'residueNum', headerName: '剩余数量', tooltipField: 'residueNum'
    },
    {
      field: 'deliveryNum', headerName: '发料数量'
    },
    {
      field: 'unitOfMeasure', headerName: '单位'
    },
    {
      field: 'demandDate', headerName: '需求日期'
    },
    {
      field: 'alternateBomDesignator', headerName: '替代BOM'
    },
    {
      field: 'earliestStartTime', headerName: '最早开始时间'
    },
    {
      field: 'fixScheduleTime', headerName: '固定时间'
    },
    {
      field: 'fpsTime', headerName: '首件开始时间'
    },
    {
      field: 'fpcTime', headerName: '首件完成时间'
    },
    {
      field: 'lpsTime', headerName: '末件开始时间'
    },
    {
      field: 'lpcTime', headerName: '末件完成时间'
    },
    {
      field: 'inspectionTime', headerName: '验货时间'
    },
    {
      field: 'fulfillTime', headerName: '最终完成时间'
    },
    {
      field: 'offsetLeadTime', headerName: '提前量'
    },
    {
      field: 'switchTime', headerName: '切换时间'
    },
    {
      field: 'scheduleFlag', headerName: '参与排产标识', valueFormatter: 'ctx.optionsFind(value,4).label'
    },
    {
      field: 'backlogFlag', headerName: '尾数标识', valueFormatter: 'ctx.optionsFind(value,4).label'
    },
    {
      field: 'backlogReason', headerName: '尾数原因'
    },
    {
      field: 'standardFlag', headerName: '标准类型', valueFormatter: 'ctx.optionsFind(value,4).label'
    },
    {
      field: 'bondedFlag', headerName: '是否保税', valueFormatter: 'ctx.optionsFind(value,4).label'
    },
    {
      field: 'completionSubinventory', headerName: '完工子库'
    },
    {
      field: 'moudleCode', headerName: '模具编码'
    },
    {
      field: 'moWarnningFlag', headerName: 'MO警告标识', valueFormatter: 'ctx.optionsFind(value,4).label'
    },
    {
      field: 'exceptionMessage', headerName: '例外信息'
    },
    {
      field: 'comments', headerName: '备注'
    },
    {
      field: 'releasedDate', headerName: '发放日期'
    },
    {
      field: 'releasedBy', headerName: '发放人'
    },
    {
      field: 'completedDate', headerName: '完成日期'
    },
    {
      field: 'closedDate', headerName: '关闭日期'
    },
    {
      field: 'closedBy', headerName: '关闭者'
    },
    {
      field: 'reqNumber', headerName: '需求订单号'
    },
    {
      field: 'reqLineNum', headerName: '需求订单行号'
    },
    {
      field: 'reqType', headerName: '需求订单类型'
    },
    {
      field: 'customerName', headerName: '客户名称'
    },
    {
      field: 'topMoNum', headerName: '顶层工单'
    },
    {
      field: 'topMoStartDate', headerName: '顶层工单开始时间'
    },
    {
      field: 'topMoStatus', headerName: '顶层工单状态', valueFormatter: 'ctx.optionsFind(value,2).label'
    },
    {
      field: 'parentMoNum', headerName: '父工单'
    },
    {
      field: 'parentMoStartDate', headerName: '父工单开始时间'
    },
    {
      field: 'parentMoStatus', headerName: '父工单状态', valueFormatter: 'ctx.optionsFind(value,2).label'
    },
    {
      field: 'derivedFlag', headerName: '拆分标识', valueFormatter: 'ctx.optionsFind(value,4).label'
    },
    {
      field: 'oriMoNumber', headerName: '原工单号'
    },
    {
      field: 'oriMoQty', headerName: '原始MO数量'
    },
    {
      field: 'levelNum', headerName: '跟单层级'
    }
  ];
  ...
  public queryFromByMo() {
    ...
    this.editService.QueryFrom(this.plantCode, this.orderId, pageIndex, pageSize).subscribe(res => {
      gridData = res.data.content;
      // 接着修改排序让总装排第一个
  ...
  query() {
    ...
    this.editService.loadGridViewNew(this.httpAction, objParmQuery, this.context);
  }
  ...
  expColumns = [
    ...
    { field: 'makeOrderStatus', title: '工单状态', width: 200, locked: false },
    ...
    { field: 'alternateBomDesignator', title: '替代bom', width: 200, locked: false },
    { field: 'earliestStartTime', title: '最早开始时间', width: 200, locked: false },
    { field: 'fixScheduleTime', title: '固定排产时间', width: 200, locked: false },
    ...
    { field: 'completionSubinventory', title: '完工子库', width: 200, locked: false },
    { field: 'moudleCode', title: '模具编码', width: 200, locked: false },
    { field: 'moWarnningFlag', title: 'MO警告标志', width: 200, locked: false },
    ...
    { field: 'orderLineNumber', title: '需求订单行号', width: 200, locked: false },
    ...
    { field: 'topMoStartDate', title: '顶层工单开始时间', width: 200, locked: false },
    { field: 'topMoStatus', title: '顶层工单状态', width: 200, locked: false },
    { field: 'parentMoNum', title: '父工单', width: 200, locked: false },
    { field: 'parentMoStartDate', title: '父工单开始时间', width: 200, locked: false },
    { field: 'parentMoStatus', title: '父工单状态', width: 200, locked: false },
  ...
  public export() {
    ...
    this.editService.exportAction({ url: this.editService.excUrlForm, method: 'GET' }, objParmQuery, this.excelexport);
  }
