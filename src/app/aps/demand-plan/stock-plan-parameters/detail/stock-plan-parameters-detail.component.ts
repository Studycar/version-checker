...
@Component({
  ...
  selector: 'stock-plan-parameters-detail',
  templateUrl: './stock-plan-parameters-detail.component.html',
  styleUrls: ['./stock-plan-parameters-detail.component.css'],
  providers: [StockPlanParametersService],
})
export class StockPlanParametersDetailComponent extends CustomBaseContext implements OnInit {
  ...
  @ViewChild('customTemplate8', { static: true }) customTemplate8: TemplateRef<any>;
  @ViewChild('customTemplate9', { static: true }) customTemplate9: TemplateRef<any>;
  @ViewChild('customTemplate10', { static: true }) customTemplate10: TemplateRef<any>;
  @Input() public item?;
  ...
  ngOnInit() {
    this.columns = [
      ...
      {
        field: 'divisionName', headerName: '*指标参数', width: 120,
        cellRendererFramework: CustomOperateCellRenderComponent,
        cellRendererParams: {
      ...
      {
        field: 'precondition', headerName: '前置条件', width: 120,
        cellRendererFramework: CustomOperateCellRenderComponent,
        cellRendererParams: {
          customTemplate: this.customTemplate8,
        },
      },
      // {
      ...
      // },
      {
        field: 'beginValueSec', headerName: '第二条件开始值', width: 150,
        cellRendererFramework: CustomOperateCellRenderComponent,
        cellRendererParams: {
          customTemplate: this.customTemplate9,
        },
      },
      {
        field: 'endValueSec', headerName: '第二条件截止值', width: 150,
        cellRendererFramework: CustomOperateCellRenderComponent,
        cellRendererParams: {
          customTemplate: this.customTemplate10,
        },
      },
      {
    ...
    this.commonQueryService.GetLookupByTypeRef('PS_COMMODITY_INDEX', this.priorityList);
