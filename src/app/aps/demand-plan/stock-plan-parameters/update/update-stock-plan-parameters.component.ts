...
@Component({
  ...
  selector: 'update-stock-plan-parameters',
  templateUrl: './update-stock-plan-parameters.component.html',
  styleUrls: ['./update-stock-plan-parameters.component.css'],
  providers: [StockPlanParametersService],
})
export class UpdateStockPlanParametersComponent implements OnInit {
