...
@Injectable()
export class CustomerDemandChangeOrderQueryService extends PlanscheduleHWCommonService {
  constructor(
  ...
  private auditUrl = this.baseUrl +'/planAudit'; // 评审
  ...
  apply(productCategory): Observable<ResponseDto> {
    return this.http.post(this.applyUrl, productCategory);
  }

  changeApproval(productCategory): Observable<ResponseDto> {
    return this.http.post(this.auditUrl, productCategory);
  }
