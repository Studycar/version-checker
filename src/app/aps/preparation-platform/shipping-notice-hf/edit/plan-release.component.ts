...
@Component({
  ...
  selector: 'preparation-platform-shipping-notice-hf-plan-release',
  templateUrl: './plan-release.component.html',
  providers: [QueryService, ShippingNoticeHfService],
})
export class PreparationPlatformShippingNoticeHfPlanReleaseComponent extends CustomBaseContext implements OnInit {
