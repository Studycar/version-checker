export const sampleProducts = [
    {
        'ProductID': 1,
        'ProductName': 'ChaiXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
        'SupplierID': 1,
        'CategoryID': 1,
    ...
    {
        'ProductID': 2,
        'ProductName': '卡手机登录饭卡就顺德房价卡死带积分卡就是打开发卡上就打飞机阿斯顿发髻上的看法',
        'SupplierID': 1,
        'CategoryID': 1,
...
export const products = [{
    ...
    'ProductID': 7,
    'ProductName': 'Uncle Bos Organic Dried Pears',
    'SupplierID': 3,
    'CategoryID': 7,
    'QuantityPerUnit': '12 - 1 lb pkgs.',
    'UnitPrice': 30.0000,
