...
import { MidItemResultService } from './query.service';
import { CustomOperateCellRenderComponent } from 'app/modules/base_module/components/custom-operatecell-render.component';

@Component({
  selector: 'algorithm-engine-mid-item-result',
  templateUrl: './mid-item-result.component.html',
  providers: [MidItemResultService]
})
export class AlgorithmEngineMidItemResultComponent extends CustomBaseContext
  implements OnInit {
  ...
  constructor(public pro: BrandService,
    ...
    public editService: MidItemResultService,
  ...
  private loadInitData() {
    ...
    // this.checkFlagNameList.push({ label: '未审核', value: '' });
    // this.checkFlagNameList.push({ label: '已审核', value: 'Y' });
    // this.checkFlagNameList.push({ label: '审核失败', value: 'N' });
