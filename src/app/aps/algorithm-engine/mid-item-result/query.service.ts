...
@Injectable()
export class MidItemResultService extends CommonQueryService {
  ...
  private baseUrl = '/api/ai/aimidpreitemresultdetailh/';
  public queryUrl = this.baseUrl + 'getItemResulPage';
  public exportUrl = this.baseUrl + 'getItemResul';
