...
import {AttachInfoService} from './attachInfo.service';
import { OssFileService } from 'app/modules/base_module/services/oss-file.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'attachInfo.component',
  templateUrl: './attachInfo.component.html',
  providers: [AttachInfoService]
})
export class AttachInfoComponent extends CustomBaseContext implements OnInit {
