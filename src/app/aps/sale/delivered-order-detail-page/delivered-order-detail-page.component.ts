...
import { DeliveredOrderDetailPageQueryService } from "./query.service";

@Component({
  selector: 'delivered-order-detail-page',
  templateUrl: './delivered-order-detail-page.component.html',
  providers: [DeliveredOrderDetailPageQueryService]
})
export class DeliveredOrderDetailPageComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: DeliveredOrderDetailPageQueryService,
