...
@Component({
  selector: 'customer-complaint-edit',
  templateUrl: './edit.component.html',
  providers: [CustomerComplaintQueryService]
})
export class CustomerComplaintEditComponent implements OnInit {
  ...
  ngOnInit() {
    if(this.i.id) {
      ...
      // this.i.orno = this.queryService.generateCode('KS', 0);
      this.i.clzt = '10';
      this.i.ksdt = new Date();
    }
    this.loadOptions();
  }
