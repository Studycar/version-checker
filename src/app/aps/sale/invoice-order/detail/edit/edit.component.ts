...
export class InvoiceOrderDetailedEditComponent implements OnInit {
  ...
  salesOrderDetailOptions = {
    ...
    6: { 'PS_CUS_GRADE': []},
    7: { 'PS_PROD_TYPE': []},
    8: { 'PS_SALES_ORDER_DETAILED_STATE_HIGH_PRICE': []},
  }
  ...
  ngOnInit() {
    if(this.i.id) {
      ...
      // this.i.detailedNum = this.queryService.generateCode2('FHDMX', 4);
      this.i.state = '10';
  ...
  public loadSalesOrderDetaileds(
    ...
    this.queryService.getSalesOrderDetailedByState({
      plantCode: this.plantCode,
      salesOrderCode: salesOrderCode,
      salesOrderState: '40',
      whCode: this.whCode,
      filterBatchCode: true, // 过滤已存在批号
      filterHighPriceState: true, // 过滤高价状态
  ...
  setSalesOrderDetail(data) {
    ...
    this.salesOrderDetail.steelStandart = data.standardsType;
    ...
    this.salesOrderDetail.warehouse = data.warehouse;
    ...
    this.salesOrderDetail.baleNo = data.baleNo;
    this.salesOrderDetail.specialMarkup = data.specialMarkup;
    this.salesOrderDetail.unitOfMeasure = data.unitOfMeasure;
    this.salesOrderDetail.unitCode = data.unitCode;
    this.salesOrderDetail.positionCode = data.positionCode;
    this.salesOrderDetail.whCode = data.whCode;
    this.salesOrderDetail.itemDescription = data.itemDescription;
    this.salesOrderDetail.standardType = data.standardType;
    this.salesOrderDetail.haveContract = data.haveContract;
