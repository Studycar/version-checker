...
@Injectable()
export class MtsPlanOptionChildEditService extends BehaviorSubject<any[]> {
  ...
  method = 'POST';
  seachUrl = '/api/ps/ppMtsPlanOption/queryMtsPlanChildKenDo';
  // 查询方法
  ...
  public Get(id: string): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/ps/ppMtsPlanOption/getByIdChild',
      id);
  }

  
  /** 根据ID获取数据 */
  public GetSubByPlant(plantCode: string): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/ps/ppMtsPlanOption/getSubByPlant',
      plantCode);
  }
  ...
  public Edit(dto: any): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/ps/ppMtsPlanOption/editChild', dto);
  ...
  RemoveBath(dtos: any[]): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/ps/ppMtsPlanOption/removeBathChild', dtos);
  }
}
