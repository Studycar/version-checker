...
@Component({
  ...
  selector: 'ps-manuf-line-spec-def',
  templateUrl: './manufLineSpecDef.component.html',
  providers: [QueryService],
})
export class PsHwManufLineSpecDefComponent extends CustomBaseContext implements OnInit {
  ...
  httpAction = { url: this.queryService.queryManufSpecDefUrl, method: 'GET' };
