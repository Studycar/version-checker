...
@Component({
  ...
  selector: 'ps-Burdening-Standard-import',
  templateUrl: './import.component.html',
  providers: [PsBurdeningStandardService],
})
export class PsBurdeningStandardImportComponent implements OnInit {


  impColumns = {
    columns: ['工厂', '工序', '产品编码', '产品描述', '钢种', '表面', '产品规格', '产品宽', '原料编码', '原料描述', '原料表面', '原料优先级',
      '原料区间', '原料宽', '规格优先级', '表面等级', '产地'],
    ...
    paramMappings: [
      ...
      { field: 'rawStockCode', title: '原料编码', columnIndex: 9, constraint: { notNull: true, } },
      { field: 'rawStockName', title: '原料描述', columnIndex: 10, constraint: { notNull: false, } },
      { field: 'rawSurface', title: '原料表面', columnIndex: 11, constraint: { notNull: true, } },
      { field: 'rawPriority', title: '原料优先级', columnIndex: 12, constraint: { notNull: true, } },
      { field: 'rawStandardsStr', title: '原料区间', columnIndex: 13, constraint: { notNull: true, } },
      { field: 'width', title: '原料宽', columnIndex: 14, constraint: { notNull: true, } },
      { field: 'standardsSortStr', title: '规格优先级', columnIndex: 15, constraint: { notNull: true, } },
      { field: 'surfaceGradeStr', title: '表面等级', columnIndex: 16, constraint: { notNull: true, } },
      { field: 'productionPlace', title: '产地', columnIndex: 17, constraint: { notNull: false, } },
  ...
  expColumns = [
    ...
    { field: 'rawStandardsStr', title: '原料区间', width: 150, locked: false },
    { field: 'width', title: '原料宽', width: 150, locked: false },
