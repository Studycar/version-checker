...
@Injectable()
export class PocSubstituteStrategyDetailEditService extends BehaviorSubject<any[]> {
  private data: any[] = [];
  ...
  public create(item: any): void {
    ...
    item.PLANT_CODE=this.plantCode;
    item.SUBSTITUTE_CODE = this.substituteCode;
  ...
  public saveChanges(): void {
    ...
    //   this.http.post(this.SubstituteStrategyManageService.saveDetailUrl, { dto: this.createdItems }).subscribe(res => {
    ...
    //   this.http.post(this.SubstituteStrategyManageService.UpdateDetailUrl, { dto: this.updatedItems }).subscribe(res => {
    //     const ress = <ActionResponseDto>res;
    //     if (ress.Success) {
    ...
    //   this.http.post(this.SubstituteStrategyManageService.DeleteDetailUrl, { dto: this.deletedItems }).subscribe(res => {
    //     const ress = <ActionResponseDto>res;
    //     if (ress.Success) {
  ...
  private fetch(action: string = '', data?: any): Observable<any[]> {
    return null;
    // return this.SubstituteStrategyManageService.GetDetail(this.plantCode, this.substituteCode)
  ...
  public GetApplications(): Observable<any> {
     return null;// this.SubstituteStrategyManageService.GetAppliaction();
  }

  /** 删除快码明细 */
  public RemoveLookupCodeValue(id: any): Observable<any> {
     return null; //this.SubstituteStrategyManageService.RemoveDetail(id);
  }
