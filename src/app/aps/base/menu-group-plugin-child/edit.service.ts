...
import { MenuGroupPluginInputDto } from '../../../modules/generated_module/dtos/menu-group-plugin-input-dto';
...
@Injectable()
export class BaseMenuGroupPluginChildEditService extends BehaviorSubject<any[]> {
  private data: any[] = [];
  ...
  method = 'POST';
  seachUrl = '/afs/servermenugroupplugin/basemenugroupb/QueryMenuGroupKenDo';
  // 查询方法
  ...
  /** 根据ID获取菜单组数据 */
  public Get(id: string, language: string): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/getByID',
      {
        id: id,
        language: language
      });
  ...
  public Edit(dto: any): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/save', dto);

  }


  /** 获取数据 递归 */
  SearchGetMenuInfo(dto: any): Observable<ResponseDto> {
    return this.http.get<ResponseDto>(
      '/api/admin/basemenugroupb/queryMenuD',
      {
        groupId	: dto.id
      }
    );
  ...
  /** 编辑菜单 */
  SaveMenuNEW(dto: any): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/saveMenuNEW',
  ...
  /** 删除菜单 */
  Remove(dto: MenuGroupPluginInputDto): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/remove',
      
        dto
      );
  }
  /** 批量删除 */
  RemoveBath(dtos: MenuGroupPluginInputDto[]): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/afs/servermenugroupplugin/basemenugroupb/RemoveBath',
      {
        dtos
      });
  }
  ...
  /** 获取所有顶级菜单*/
  GetMenuTOP(): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/getMenuTOP',
      {
      });
  }

  /** 获取所有子菜单*/
  GetMenuChild(): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/getMenuChild',
      {
      });
  }
