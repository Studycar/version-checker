...
@Injectable()
export class BaseMenuGroupPluginEditService extends BehaviorSubject<any[]> {
  private data: any[] = [];
  ...
  method = 'POST';
  seachUrl = '/api/admin/basemenugroupb/queryMenuGroupKenDo';
  // 查询方法
  ...
  public imports(dto: any): Observable<ResponseDto> {
    return this.http.post<ResponseDto>(
      '/api/admin/basemenugroupb/imports', dto
    );
  }
}
