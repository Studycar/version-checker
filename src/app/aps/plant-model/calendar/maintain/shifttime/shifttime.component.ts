...
import { PlantModelCalendarShiftTimeEditComponent } from './edit/edit.component';
import { CustomOperateCellRenderComponent } from 'app/modules/base_module/components/custom-operatecell-render.component';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'plant-model-calendar-shifttime',
  templateUrl: './shifttime.component.html',
  providers: [QueryService],
})
export class PlantModelCalendarShiftTimeComponent extends CustomBaseContext implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('CALENDAR_CODE：' + this.i.calendarCode);
    // 日历编码
  ...
  public add(item?: any) {
    this.modal
      .static(PlantModelCalendarShiftTimeEditComponent, { i: (item !== undefined ? this.clone(item) : { id: null }) })
