...
@Component({
  ...
  providers: [MixedResourceIssuedResourceIssuedEditService, CommonQueryService]
})
export class MixedResourceIssuedPlanOrderComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(private http: _HttpClient,
    ...
    public queryService: MixedResourceIssuedResourceIssuedEditService,
  ) {
