...
import { MarkupSubsecQueryService } from "../query.service";

@Component({
  selector: 'markup-subsec-import',
  templateUrl: './import.component.html',
  providers: [MarkupSubsecQueryService]
})
export class MarkupSubsecImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '分卷方式', '分卷加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'subsectionStateDesc', title: '分卷方式', columnIndex: 4, constraint: { notNull: true } },
      { field: 'subsectionMarkup', title: '分卷加价', columnIndex: 5, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'subsectionStateDesc', title: '分卷方式', width: 150, locked: false },
    { field: 'subsectionMarkup', title: '分卷加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupSubsecQueryService,
