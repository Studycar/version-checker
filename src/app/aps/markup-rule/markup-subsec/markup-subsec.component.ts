...
import { MarkupSubsecEditComponent } from "./edit/edit.component";
import { MarkupSubsecImportComponent } from "./import/import.component";
import { MarkupSubsecQueryService } from "./query.service";

@Component({
  selector: 'markup-subsec',
  templateUrl: './markup-subsec.component.html',
  providers: [MarkupSubsecQueryService]
})
export class MarkupSubsecComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupSubsecQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_SUBSEC_HISTORY';
    this.modal.static(
