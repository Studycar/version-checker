...
import { MarkupElementCccdEditComponent } from './edit/edit.component';
import { MarkupElementCccdImportComponent } from './import/import.component';
import { MarkupElementCccdQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-element-cccd',
  templateUrl: './markup-element-cccd.component.html',
  providers: [MarkupElementCccdQueryService]
})
export class MarkupElementCccdComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupElementCccdQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_CCCD_HISTORY';
    this.modal.static(
