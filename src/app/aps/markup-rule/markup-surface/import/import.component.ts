...
@Component({
  selector: 'markup-surface-import',
  templateUrl: './import.component.html',
  providers: [MarkupSurfaceQueryService]
})
export class MarkupSurfaceImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '表面加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'surfaceMarkup', title: '表面加价', columnIndex: 5, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'surfaceMarkup', title: '表面加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupSurfaceQueryService,
