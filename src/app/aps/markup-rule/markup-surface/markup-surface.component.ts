...
import { MarkupSurfaceEditComponent } from "./edit/edit.component";
import { MarkupSurfaceImportComponent } from "./import/import.component";
import { MarkupSurfaceQueryService } from "./query.service";

@Component({
  selector: 'markup-surface',
  templateUrl: './markup-surface.component.html',
  providers: [MarkupSurfaceQueryService]
})
export class MarkupSurfaceComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupSurfaceQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_SURFACE_HISTORY';
    this.modal.static(
