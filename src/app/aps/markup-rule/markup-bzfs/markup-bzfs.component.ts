...
import { MarkupElement6EditComponent } from './edit/edit.component';
import { MarkupElement6ImportComponent } from './import/import.component';
import { MarkupElement6QueryService } from './query.service';

@Component({
  selector: 'markup-bzfs',
  templateUrl: './markup-bzfs.component.html',
  providers: [MarkupElement6QueryService]
})
export class MarkupElement6Component extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupElement6QueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_BZFS_HISTORY';
    this.modal.static(
