...
@Component({
  ...
  selector: 'markup-pb-import',
  templateUrl: './import.component.html',
  providers: [MarkupPbQueryService]
})
export class MarkupPbImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '是否受托', '厚度(<)', '厚度(>=)', '平板加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'pbMarkup', title: '平板加价', columnIndex: 70, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'pbMarkup', title: '平板加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupPbQueryService,
