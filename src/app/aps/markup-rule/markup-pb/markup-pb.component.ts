...
import { MarkupPbEditComponent } from './edit/edit.component';
import { MarkupPbImportComponent } from './import/import.component';
import { MarkupPbQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-pb',
  templateUrl: './markup-pb.component.html',
  providers: [MarkupPbQueryService]
})
export class MarkupPbComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupPbQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_PB_HISTORY';
    this.modal.static(
