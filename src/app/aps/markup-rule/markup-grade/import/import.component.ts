...
import { MarkupGradeQueryService } from "../query.service";

@Component({
  selector: 'markup-grade-import',
  templateUrl: './import.component.html',
  providers: [MarkupGradeQueryService]
})
export class MarkupGradeImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '等级', '等级加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'gradeDesc', title: '等级', columnIndex: 4, constraint: { notNull: true } },
      { field: 'gradeMarkup', title: '等级加价', columnIndex: 5, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'gradeDesc', title: '等级', width: 150, locked: false },
    { field: 'gradeMarkup', title: '等级加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupGradeQueryService,
