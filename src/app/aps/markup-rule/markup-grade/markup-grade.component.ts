...
import { MarkupGradeEditComponent } from "./edit/edit.component";
import { MarkupGradeImportComponent } from "./import/import.component";
import { MarkupGradeQueryService } from "./query.service";

@Component({
  selector: 'markup-grade',
  templateUrl: './markup-grade.component.html',
  providers: [MarkupGradeQueryService]
})
export class MarkupGradeComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupGradeQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_GRADE_HISTORY';
    this.modal.static(
