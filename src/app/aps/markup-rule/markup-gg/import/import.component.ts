...
@Component({
  ...
  selector: 'markup-gg-import',
  templateUrl: './import.component.html',
  providers: [MarkupGgQueryService]
})
export class MarkupGgImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '客户简称', '钢种大类', '钢种', '表面', '是否整卷', '厚度(<)', '厚度(>=)', '宽度(<)', '宽度(>=)', '规格加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'fullVolumeDesc', title: '是否整卷', columnIndex: 2, constraint: { notNull: true } },
      ...
      { field: 'ggMarkup', title: '规格加价', columnIndex: 70, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'fullVolumeDesc', title: '是否整卷', width: 150, locked: false },
    ...
    { field: 'ggMarkup', title: '规格加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupGgQueryService,
