...
import { MarkupGgEditComponent } from './edit/edit.component';
import { MarkupGgImportComponent } from './import/import.component';
import { MarkupGgQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-gg',
  templateUrl: './markup-gg.component.html',
  providers: [MarkupGgQueryService]
})
export class MarkupGgComponent extends CustomBaseContext implements OnInit {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_GG_HISTORY';
    this.modal.static(
