...
import { MarkupTtQueryService } from '../query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-tt-import',
  templateUrl: './import.component.html',
  providers: [MarkupTtQueryService]
})
export class MarkupTtImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '套筒类型', '厚度(<)', '厚度(>=)', '纸筒/铁桶加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'ttTypeDesc', title: '套筒类型', columnIndex: 3, constraint: { notNull: true, } },
      ...
      { field: 'ttMarkup', title: '纸筒/铁桶加价', columnIndex: 70, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'ttTypeDesc', title: '套筒类型', width: 150, locked: false },
    { field: 'thicknessMax', title: '厚度(<)', width: 150, locked: false },
    { field: 'thicknessMin', title: '厚度(>=)', width: 150, locked: false },
    { field: 'ttMarkup', title: '纸筒/铁桶加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupTtQueryService,
