...
import { MarkupTtEditComponent } from './edit/edit.component';
import { MarkupTtImportComponent } from './import/import.component';
import { MarkupTtQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-tt',
  templateUrl: './markup-tt.component.html',
  providers: [MarkupTtQueryService]
})
export class MarkupTtComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupTtQueryService,
  ) {
  ...
  expColumnsOptions: any[] = [
    ...
    { field: 'ttType', options: this.ttTypeOptions },
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_TT_HISTORY';
    this.modal.static(
