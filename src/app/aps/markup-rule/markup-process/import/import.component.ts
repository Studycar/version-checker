...
@Component({
  ...
  selector: 'markup-process-import',
  templateUrl: './import.component.html',
  providers: [MarkupProcessQueryService]
})
export class MarkupProcessImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '是否受托', '厚度(<)', '厚度(>=)', '加工类型加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'markupElementProcess', title: '加工类型加价', columnIndex: 70, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'markupElementProcess', title: '加工类型加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupProcessQueryService,
