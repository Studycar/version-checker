...
import { MarkupProcessEditComponent } from './edit/edit.component';
import { MarkupProcessImportComponent } from './import/import.component';
import { MarkupProcessQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-process',
  templateUrl: './markup-process.component.html',
  providers: [MarkupProcessQueryService]
})
export class MarkupProcessComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupProcessQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_PROCESS_HISTORY';
    this.modal.static(
