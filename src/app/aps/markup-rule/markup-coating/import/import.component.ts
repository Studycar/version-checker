...
import { MarkupCoatingQueryService } from "../query.service";

@Component({
  selector: 'markup-coating-import',
  templateUrl: './import.component.html',
  providers: [MarkupCoatingQueryService]
})
export class MarkupCoatingImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '胶膜标签描述', '胶膜加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'labelDesc', title: '胶膜标签描述', columnIndex: 4, constraint: { notNull: true } },
      { field: 'coatingMarkup', title: '胶膜加价', columnIndex: 5, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'labelDesc', title: '胶膜标签描述', width: 150, locked: false },
    { field: 'coatingMarkup', title: '胶膜加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupCoatingQueryService,
