...
import { MarkupCoatingEditComponent } from "./edit/edit.component";
import { MarkupCoatingImportComponent } from "./import/import.component";
import { MarkupCoatingQueryService } from "./query.service";

@Component({
  selector: 'markup-coating',
  templateUrl: './markup-coating.component.html',
  providers: [MarkupCoatingQueryService]
})
export class MarkupCoatingComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupCoatingQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_COATING_HISTORY';
    this.modal.static(
