...
@Component({
  selector: 'markup-element-rebate-edit',
  templateUrl: './edit.component.html',
  providers: [MarkupElementRebateQueryService]
})
export class MarkupElementRebateEditComponent implements OnInit {
  ...
  save(value) {
    const params = Object.assign({}, this.i, {
      startDate: this.queryService.formatDateTime(this.i.startDate),
      endDate: this.queryService.formatDateTime(this.i.endDate),
    });
