...
import { MarkupJSFSEditComponent } from "./edit/edit.component";
import { MarkupJSFSImportComponent } from "./import/import.component";
import { MarkupJSFSQueryService } from "./query.service";

@Component({
  selector: 'markup-jsfs',
  templateUrl: './markup-jsfs.component.html',
  providers: [MarkupJSFSQueryService]
})
export class MarkupJSFSComponent extends CustomBaseContext implements OnInit {
  ...
  expColumnsOptions: any[] = [
    ...
    { field: 'jsfs', options: this.settleStyleOptions },
  ];
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_JSFS_HISTORY';
    this.modal.static(
