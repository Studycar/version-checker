...
@Component({
  ...
  selector: 'markup-sitting-import',
  templateUrl: './import.component.html',
  providers: [MarkupSittingQueryService]
})
export class MarkupSittingImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '是否受托', '重量(<)', '重量(>=)', '厚度(<)', '厚度(>=)', '宽度(<)', '宽度(>=)', '分条加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'weightMax', title: '重量(<)', columnIndex: 50, constraint: { notNull: true, } },
      { field: 'weightMin', title: '重量(>=)', columnIndex: 60, constraint: { notNull: true, } },
      ...
      { field: 'widthMax', title: '宽度(<)', columnIndex: 50, constraint: { notNull: true, } },
      { field: 'widthMin', title: '宽度(>=)', columnIndex: 60, constraint: { notNull: true, } },
      { field: 'sittingMarkup', title: '分条加价', columnIndex: 70, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'weightMax', title: '重量(<)', width: 150, locked: false },
    { field: 'weightMin', title: '重量(>=)', width: 150, locked: false },
    { field: 'thicknessMax', title: '厚度(<)', width: 150, locked: false },
    { field: 'thicknessMin', title: '厚度(>=)', width: 150, locked: false },
    { field: 'widthMax', title: '宽度(<)', width: 150, locked: false },
    { field: 'widthMin', title: '宽度(>=)', width: 150, locked: false },
    { field: 'sittingMarkup', title: '分条加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupSittingQueryService,
