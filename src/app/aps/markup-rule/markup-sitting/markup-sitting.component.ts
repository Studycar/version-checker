...
import { MarkupSittingEditComponent } from './edit/edit.component';
import { MarkupSittingImportComponent } from './import/import.component';
import { MarkupSittingQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-sitting',
  templateUrl: './markup-sitting.component.html',
  providers: [MarkupSittingQueryService]
})
export class MarkupSittingComponent extends CustomBaseContext implements OnInit {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_SITTING_HISTORY';
    this.modal.static(
