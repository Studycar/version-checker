...
import { MarkupInnerDiaEditComponent } from './edit/edit.component';
import { MarkupInnerDiaImportComponent } from './import/import.component';
import { MarkupInnerDiaQueryService } from './query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-inner-dia',
  templateUrl: './markup-inner-dia.component.html',
  providers: [MarkupInnerDiaQueryService]
})
export class MarkupInnerDiaComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupInnerDiaQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_INNER_DIA_HISTORY';
    this.modal.static(
