...
import { MarkupInnerDiaQueryService } from '../query.service';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'markup-inner-dia-import',
  templateUrl: './import.component.html',
  providers: [MarkupInnerDiaQueryService]
})
export class MarkupInnerDiaImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '是否受托', '内径规格', '内径加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'innerDia', title: '内径规格', columnIndex: 50, constraint: { notNull: true, } },
      { field: 'innerDiaMarkup', title: '内径加价', columnIndex: 70, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'innerDia', title: '内径规格', width: 150, locked: false },
    { field: 'innerDiaMarkup', title: '内径加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupInnerDiaQueryService,
