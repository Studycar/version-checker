...
import { MarkupHBEditComponent } from "./edit/edit.component";
import { MarkupHBImportComponent } from "./import/import.component";
import { MarkupHBQueryService } from "./query.service";

@Component({
  selector: 'markup-hb',
  templateUrl: './markup-hb.component.html',
  providers: [MarkupHBQueryService]
})
export class MarkupHBComponent extends CustomBaseContext implements OnInit {
  ...
  constructor(
    ...
    public queryService: MarkupHBQueryService,
  ) {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_HB_HISTORY';
    this.modal.static(
