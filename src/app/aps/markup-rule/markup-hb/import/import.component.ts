...
import { MarkupHBQueryService } from "../query.service";

@Component({
  selector: 'markup-hb-import',
  templateUrl: './import.component.html',
  providers: [MarkupHBQueryService]
})
export class MarkupHBImportComponent implements OnInit {

  options;

  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '厚薄料', '厚薄料加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'houboDesc', title: '厚薄料', columnIndex: 4, constraint: { notNull: true } },
      { field: 'hbMarkup', title: '厚薄料加价', columnIndex: 5, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'houboDesc', title: '厚薄料', width: 150, locked: false },
    { field: 'hbMarkup', title: '厚薄料加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupHBQueryService,
