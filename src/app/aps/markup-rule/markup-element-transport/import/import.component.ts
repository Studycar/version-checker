...
@Component({
  selector: 'markup-element-transport-import',
  templateUrl: './import.component.html',
  providers: [MarkupElementTransportQueryService]
})
export class MarkupElementTransportImportComponent implements OnInit {

  options;
  
  impColumns = {
    columns: ['工厂', '存货名称', '钢种大类', '钢种', '表面', '运输方式', '目的地', '运输方式加价', '生效日期', '失效日期'],
    paramMappings: [
      ...
      { field: 'transportTypeDesc', title: '运输方式', columnIndex: 4, constraint: { notNull: true } },
      { field: 'distributionWarehouse', title: '目的地', columnIndex: 4, constraint: { notNull: true } },
      { field: 'ysfsMarkup', title: '运输方式加价', columnIndex: 5, constraint: { notNull: true, } },
  ...
  expColumns = [
    ...
    { field: 'transportTypeDesc', title: '运输方式', width: 150, locked: false },
    { field: 'distributionWarehouse', title: '目的地', width: 150, locked: false },
    { field: 'ysfsMarkup', title: '运输方式加价', width: 150, locked: false },
  ...
  constructor(
    ...
    private queryService: MarkupElementTransportQueryService,
