...
import { MarkupElementTransportEditComponent } from "./edit/edit.component";
import { MarkupElementTransportImportComponent } from "./import/import.component";
import { MarkupElementTransportQueryService } from "./query.service";

@Component({
  selector: 'markup-ysfs',
  templateUrl: './markup-element-transport.component.html',
  providers: [MarkupElementTransportQueryService]
})
export class MarkupElementTransportComponent extends CustomBaseContext implements OnInit {
   ...
   */
   showChangeDetail() {
    const tableName = 'PS_MARKUP_YSFS_HISTORY';
    this.modal.static(
