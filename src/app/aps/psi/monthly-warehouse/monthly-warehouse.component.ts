...
import { MonthlyWarehouseEditComponent } from './edit/edit.component';
import { MonthlyWarehouseCopyComponent } from './copy/copy.component';
import { MonthlyWarehouseImportComponent } from './import/import.component';

@Component({
  selector: 'monthly-warehouse',
  templateUrl: './monthly-warehouse.component.html',
  providers: [QueryService]
})
export class MonthlyWarehouseComponent extends CustomBaseContext implements OnInit {
  ...
  httpAction = {
    url: '/api/sop/sys/sopProdcutMonthPsiRate/page',
    method: 'POST',
  }
  ...
  // 导入
  imports() {
    this.modal.static(MonthlyWarehouseImportComponent, {}, 'md').subscribe(value => {
      this.query();
    });
  }
}
